...
const topicDefinitions: readonly TopicDefinition[] = [
  ...
  },
  {
    ...
    summary:
      'System boundaries, frontend data flow, integration styles, and patterns used in proportion to risk.',
    category: 'Systems',
    keywords: [
      'architecture',
      'microservices',
  ...
  },
  {
    ...
    category: 'Systems',
    keywords: ['core web vitals', 'inp', 'lcp', 'seo', 'code splitting'],
    order: 8,
  ...
  },
  {
    ...
    summary:
      'GraphQL operational controls and a semantics-first comparison of event logs and message brokers.',
    category: 'Systems',
    keywords: ['graphql', 'kafka', 'rabbitmq', 'pub sub', 'queues'],
    order: 9,
  ...
  },
  {
    ...
    summary:
      'Test boundaries, code quality, continuous delivery, builds, operations, and work priority.',
    category: 'Delivery',
    keywords: ['testing', 'ci cd', 'devops', 'quality', 'priority'],
    order: 10,
  ...
  },
  {
    ...
    category: 'Delivery',
    keywords: ['git', 'npm', 'pnpm', 'terminal', 'editor'],
    order: 11,
