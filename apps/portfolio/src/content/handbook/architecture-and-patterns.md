...
Further reading: [web architecture fundamentals](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Server-side/First_steps/Client-Server_overview) and [Martin Fowler's architecture guide](https://martinfowler.com/architecture/).
